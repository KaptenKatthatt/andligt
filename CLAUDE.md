...
**Fas 8 — Källor och kontext klar, mergad till `main` (#28):** källpassager,
skärpt publiceringsgrind (publicerad källa måste deklarera `upphov` och
`datering`), källkontext i läsrummet.

**Alan Watts-spåret (#25, mergat 2026-07-14):** researchrapporten
`docs/research/alan-watts.md` slår fast att Watts *idéer* används fritt med egna
ord (hans ordalydelse är skyddad t.o.m. 2043; korta verifierade bokcitat endast
inom analys; aldrig postuma kompilationer/YouTube; aldrig som zenauktoritet).
Roadmapen Fas 12 har sektionen *Modern Interpreters: Alan Watts* med planerade
rum per tema. Biblioteket har nu **7 traditioner och 12 källposter** (alla
ingesterade verk täckta, inkl. Bibeln 1917, eddorna, Analekterna) — publicerade
och godkända via ägarens merge.

**Nästa: första rummen ur Watts-planen** (roadmap Fas 12 + rapportens avsnitt 6):
t.ex. »Vattnet« (Daodejing 78, Lugn), »Oro för morgondagen« (Matt 6 + Dhammapada
+ Predikaren, Lugn), »Vagnen« (Milindapañha, Människan — kräver ny källpost),
eller Historia-rummet »Tolken i väst« om Watts själv. Följ rumsmönstret från
Fas 7-rummen och Fas 8:s grind (passager med exakta referenser).
